    ...
    <div className="relative flex flex-col border rounded-sm border-[#8ed0b8] bg-[#dbf1e9]">
      <nav className="flex min-w-[240px] flex-col gap-1 p-2">
        {field.options?.map((option) => {
          ...
          return (
            <div role="button" key={optionId} className="flex w-full items-center rounded-lg p-0 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100">
              <label htmlFor={optionId} className="flex w-full cursor-pointer items-center px-3 py-2">
                <div className="inline-flex items-center">
                  <label htmlFor={optionId} className="relative flex cursor-pointer items-center">
                  ...
                  <label htmlFor={optionId} className="ml-2 cursor-pointer text-sm text-black">
                    {option.label}
                  </label>
                </div>
              </label>
